...
interface WitcherFacts {
    [key: string]: string;
}

const witcherFacts: WitcherFacts = {
...
const FactsPage: React.FC = () => {
  ...
  const [factVisibility, setFactVisibility] = useState<Record<string, boolean>>({});

  const handleClick = (factId: string) => {
