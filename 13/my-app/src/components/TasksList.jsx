            ...
            <div className='container'>
                <div className='tasks'>
                    ...
                    {this.state.tasks.map((task) => (
                        !task.done && <TaskItem key={task.id} id={task.id} task={task.task} action={this.removeTask} />
                    ))}
                </div>
                ...
                <div className='tasks2'>
                    <div className='tasks-done'>
                        ...
                        {this.state.doneTasks.map((task) => (
                            task.done && <TaskDone key={task.id} id={task.id} task={task.task} done={this.toggleDone} />
                        ))}
                    </div>
                </div>
            </div>
